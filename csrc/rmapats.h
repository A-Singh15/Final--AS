...
typedef struct {
    ...
    U  I1048;
    U  I1049;
    HsimSignalMonitor  * I1050;
    RP  I1051;
    RmaTimeStamp64  I1052;
    U  I1053;
...
typedef struct {
    U  I748;
    U  I756;
    RmaThreadSchedCompiledLoads  * I1084;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    ...
    U  I1162 :1;
    U  I956 :9;
    RmaSeqPrimOutputOnClkOpt  I1164;
    RmaSeqPrimOutputEblkData  I1168;
...
struct dummyq_struct {
    ...
    struct futq * I1275;
    struct futq * I1276;
    struct sched_table * I1277;
    struct futq_info * I1279;
    struct futq_info * I1281;
    U  I1282;
    U  I1283;
    U  I1284;
    U  I1285;
...
void  hs_0_M_0_1__simv_daidir (UB  * pcode, scalar  val, U  I711, scalar  * I1389, U  did);
...
void  hs_0_M_1_1__simv_daidir (UB  * pcode, scalar  val, U  I711, scalar  * I1389, U  did);
...
void  hs_0_M_5_1__simv_daidir (UB  * pcode, scalar  val, U  I711, scalar  * I1389, U  did);
...
void  hs_0_M_6_1__simv_daidir (UB  * pcode, scalar  val, U  I711, scalar  * I1389, U  did);
...
void  hs_0_M_7_1__simv_daidir (UB  * pcode, scalar  val, U  I711, scalar  * I1389, U  did);
...
void  hs_0_M_9_1__simv_daidir (UB  * pcode, scalar  val, U  I711, scalar  * I1389, U  did);
...
void  hs_0_M_12_0__simv_daidir (UB  * pcode, vec32  * I1077, U  I967);
